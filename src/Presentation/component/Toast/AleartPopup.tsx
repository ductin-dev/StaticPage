...
export interface AleartPopupType {
    detail: string;
    type: "error" | "warning" | "success";
    onClose?: () => void;
};

const AleartPopup: FC<AleartPopupType> = ({ detail, type, onClose }) => {
    return (
        <div id="toast-danger" className="flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400" role="alert" style={{ background: "none", border: "none" }}>
            {
                {
                    'error':
            ...
            <div className="ml-3 text-sm font-normal">{detail}</div>
